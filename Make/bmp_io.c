...
/**
   \brief Функция чтения изображения bmp
   \param *bmp_file_path Путь к файлу с  изображением bmp
   \return Искуственную структуру bmp_image
*/
...
/**
   \brief Функция записи нового изображения bmp
   \param *bmp_file_path Путь для нового файла с  изображением bmp
